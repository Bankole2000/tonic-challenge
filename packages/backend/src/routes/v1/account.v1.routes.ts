...
import { accountDepositHandler, accountWithdrawalHandler, findUserAccountHandler, getAccountDetailsHandler, getAccountTransactionsHandler, transferHandler } from '../../controllers/v1/account.controllers';
import { validate } from '../../middleware/v1/zodValidate.v1.middleware';
import { accountDepositSchema, accountWidthrawSchema, createAccountSchema, transferSchema } from '../../utils/validators/account.schema';
